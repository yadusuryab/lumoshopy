...
export default function CookiesPolicy() {
  return (
    <>
      <Head>
        <title>Cookies Policy - lumo shopy</title>
        <meta name="description" content="Learn how lumo shopy uses cookies to enhance your browsing experience." />
      </Head>
      <div className="container mx-auto p-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            <strong>Company:</strong> Refers to lumo shopy ("the Company", "We", "Us", or "Our").
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> Refers to lumo shopy, accessible from
            <a href="https://lumo shopy.co.in" target="_blank" rel="noopener noreferrer" className="text-blue-500"> lumo shopy.co.in</a>.
          </li>
          <li>
        ...
        <p>
          ...
          <a
            href="https://lumo shopy.co.in/contact"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500"
          >
            lumo shopy.co.in/contact
          </a>
          .
        </p>
      </div>
